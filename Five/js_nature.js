        ...
        <meta charset="utf-8">
            ...
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
                <meta name="viewport" content="width=device-width, initial-scale=1">
                    <title>第五题 js 混淆 乱码增强 - 猿人学</title>
                    <link rel="stylesheet" href="/static/match/dist/css/style.css">
                        <link rel="stylesheet" href="/static/match/match5/match5.css">
                            ...
                            <link rel="stylesheet"
                                ...
                                <link rel="stylesheet" href="/static/asset/css/modallayer.min.css">
                                    ...
                                    <style>
                                        .pagination-outer{text - align:center}.pagination{background:#151515;font-family:'Sniglet',cursive;padding:5px;box-shadow:inset 0 0 2px 2px rgba(0,0,0,0.5);border-radius:50px;display:inline-flex;position:relative}#modal-layer-container{position:fixed;!important;top:50%;!important;left:50%;!important;margin-left:-100px;!important;margin-top:-45px;!important}.pagination
                                        li
                                        ...
                                        li:first-child a.page-link{border - radius:40px 0 0 40px}.pagination
                                        li:last-child a.page-link{margin - right:0;border-radius:0 40px 40px 0}@media
                                        only screen
                                    ...
                                    <style>
                                        h2{width:50%!important;margin:0 auto;margin-bottom:30px}h3{width:50%!important;margin:0 auto;margin-bottom:30px}*{box - sizing:border-box}body{font - family:"HelveticaNeue-Light","Helvetica Neue Light";color:white;font-size:12px;background:#333}form{background:#111;width:300px;margin:30px auto;border-radius:0.4em;border:1px solid#191919;overflow:hidden;position:relative;box-shadow:0 5px 10px 5px rgba(0,0,0,0.2)}form:after{content:"";display:block;position:absolute;height:1px;width:100px;left:20%;background:linear-gradient(to right,#111111,#444444,#b6b6b8,#444444,#111111);top:0}form:before{content:"";display:block;position:absolute;width:8px;height:5px;border-radius:50%;left:34%;top:-7px;box-shadow:0 0 6px 4px#fff}.inset{padding:20px;border-top:1px solid#19191a}form
                                    ...
                                    <style>ul{list - style:none}.zhibo ul li{display:inline;text-align:center}</style>
    </head>
    <body class="is-boxed has-animations">
        <div class="body-wrap">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="background-color: #0f1114;max-height: 500px; overflow:auto;">
                        ...
                        <div class="modal-body" style="color: white;font-size: 15px">
                            <!--1.<b style="color: #ffdd00">【重要通知】</b>我的猿人学爬虫逆向课在做元宵节活动，优惠 <b style="color: red">700</b>元，课程包含安卓逆向抓取、JS 逆向抓取，安卓群控抓取、容器定制化、抓取黑科技。-->
                            ...
                            刷题须知</a>】（点击即可查看）之后请使用 新版 【<b style="color: red">chrome</b>】 浏览器打开题目。如遇题目异常，请先
                            <b style="color: red">
                                <a target="_blank" style="color: red;text-decoration: none;"
                                   href="https://www.baidu.com/s?ie=UTF-8&wd=%E6%A0%A1%E5%87%86%E7%B3%BB%E7%BB%9F%E7%9A%84%E6%97%B6%E9%97%B4">
                                    校准系统的时间
                                </a>
                            </b>
                            ，并且开启无痕模式进行尝试。
                            <p></p>
                            2.<b style="color: #ffdd00">【重要通知】</b>建了一个 本网站的 刷题 交流群，扫下方二维码，备注“刷题”，加我私人微信，拉你进 猿人学-爬虫对抗赛 刷题
                            交流群。
                            <p></p>
                            <p>后面新出的对抗题，也在群里通知。</p>
                            <p style="text-align: center">
                                <img alt="" src="/static/match/dist/images/group.jpg"
            ...
            <div style="margin-top: 4%">
                <h2 class="hero-title mt-0">任务5：抓取全部5页直播间热度，计算前<b style="color: red">5</b>名直播间热度的
                    <b style="color: red">加和</b>
                </h2>
                <h3 class="hero-title mt-0">注：本页cookie有效期仅有50秒钟</h3>
                <div class="zhibo">
                    <ul class="zbu"
                        style="text-align: center; padding-left: 0; max-width: 1500px; margin: 0 auto;"></ul>
                </div>
                <div class="container">
                    <div class="row pad-15">
                        <div class="col-md-12">
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item before-page">
                                        <a class="page-link" aria-label="Previous">
                                            <span aria-hidden="true">«</span>
                                        </a>
                                    </li>
                                    <li class="page-item page-message active">
                                        <a class="page-link">1</a>
                                    </li>
                                    <li class="page-item page-message">
                    ...
                    <div class="inset">
                        ...
                        <p>
                            <input type="hidden" name="id" value="5">
                                <input type="button" value="提交答案" id="ajaxSubmit">
                        </p>
                    </div>
                </form>
            </div>
            <footer class="site-footer">
                <div class="container">
                    <div class="site-footer-inner">
                        ...
                        <div class="footer-copyright">Copyright &copy; 2020 猿人学 Python &nbsp&nbsp&nbsp
                            <a target="_blank" href="http://www.beian.miit.gov.cn/publish/query/indexFirst.action">
                                备案号：蜀ICP备18020009号-3
                            </a>
                        </div>
                    </div>
                </div>
...
function download_img() {
	...
	let poster_html = `
					...
					<div class="poster">
						...
						<span class="post_name">通关人： <b style="color: #ff6600">` + name.replace('@','') + `
            </b>
        </span>
        ...
        uqiop_date.setTime(uqiop_date.getTime() + 24* 60 * 60 * 1000);
        document.cookie = 'qpfccr=true;path=/;expires=' + uqiop_date.toUTCString();
        document.cookie = 'no-alert2=true; path=/'
        });
        if ($.cookie('no-alert2') !== 'true'){
        (function (){$('.alert_ban').click()})()
        }

        </script></div><script src="/match/5/rq.js"></script><script>function _$KS() {
        ...
        _$KS();</script><script src="/static/match/dist/js/main.min.js"></script><script>window.url='/api/match/5';request=function(){var list={"page":window.page,"m":window._$is,"f":window.$_zw[23]};$.ajax({url:window.url,dataType:"json",async:false,data:list,type:"GET",beforeSend:function(request){},success:function(data){if(window.page){}else{window.page=1}data=data.data;let name=['极镀ギ紬荕','爷灬霸气傀儡','梦战苍穹','傲世哥','мaη肆風聲','一刀メ隔世','横刀メ绝杀','Q不死你R死你','魔帝殤邪','封刀不再战','倾城孤狼','戎马江湖','狂得像风','影之哀伤','謸氕づ独尊','','傲视狂杀','追风之梦','枭雄在世','傲视之巅','黑夜刺客','占你心为王','爷来取你狗命','御风踏血','凫矢暮城','孤影メ残刀','野区霸王','噬血啸月','风逝无迹','帅的睡不着','血色杀戮者','冷视天下','帅出新高度','風狆瑬蒗','灵魂禁锢','ヤ地狱篮枫ゞ','溅血メ破天','剑尊メ杀戮','塞外う飛龍','哥‘K纯帅','逆風祈雨','恣意踏江山','望断、天涯路','地獄惡灵','疯狂メ孽杀','寂月灭影','骚年霸称帝王','狂杀メ无赦','死灵的哀伤','撩妹界扛把子','霸刀☆藐视天下','潇洒又能打','狂卩龙灬巅丷峰','羁旅天涯.','南宫沐风','风恋绝尘','剑下孤魂','一蓑烟雨','领域★倾战','威龙丶断魂神狙','辉煌战绩','屎来运赚','伱、Bu够档次','九音引魂箫','骨子里的傲气','霸海断长空','没枪也很狂','死魂★之灵'];let title_name=['斗鱼零食铺大牌零食秒杀天天有！','虽然时间不长但我不鸽','录电台❤是为之心动的声音啊！','【洛洛无人声放松休息解压】直播画画','生病了 今天休息了。9.27','【国语点唱】我的伯乐你在哪？❤','我最最最喜欢你啦！','你会是真正的欧皇吗？','怎么样才能发现我~','你们不进来良心不痛吗','梨落想要和你去看星辰大海~～','钢琴主播：早10:30晚7:30','中国好声音 前五名二次元萌妹 你想听都有','多音色声优御萝小可爱~','【年鹏】今天鸽了 明天解说','小鱼人柱力教学局重拳出击.我行你也行','貂蝉/碎片/友情卷❤','热血传奇-红月单职业-传奇','至尊爆天甲 至尊盘龙 锦鲤 水龙吟 智慧','【灵狐电台】来投稿啊！在干嘛啊？！','人美声甜小姐姐寻房管啦','比赛 排位 最强打野英雄。','西瓜：faceit上上分','有车位 国庆放假一起打游戏呀','【海涛】教练我想打dota！','墨泽：血洗元素酒馆！','铁哥：啦啦啦啦啦啦','男女大枪上号不排队 赛季任务','LGD对阵RNG 冲！！！','竞技单人四排~京腔爆笑单四大神嗨翻全场','解说米勒：米老八重返棋坛','中秋送好礼，手慢无','诗诗：让你失望一次的人不会让你只失望一次','绿豆：大号福能 帮水友打号 定级','【戈戈】丐帮少林...办个卡呗','SUNRISE-future亚洲黄金','来呀！下饭吖~~~','10月友情~',' 风女King峡谷小号冲千分！！！！',' 【绝地取经女团】师傅是御姐吗？',' 黑玫 声优阿狸玩家',' 开开FIFA的卡',' 【绝地马戏团】直播不认真，你干嘛要直播？',' 诺手新主播峡谷宗师上王者！',' 稻哥：竞 技 场✌',' 十二点的魅力秒~怼个爆天雷诺~',' 不上班的周一 早上好^^',' 很精彩的1v1。节目效果也非常好。',' 今天不出前4上前十',' 佐伊绝活哥峡谷狙击职业哥',' 小李：努力才配拥有正茂风华',' 有车位 带你飙车',' 真是又菜又爱玩 .....',' 再强一点单人四排',' WSS：吃好喝好，长生不老',' 亏王：至尊盘龙不出的盘起来',' 绝活狮子狗落地秒教学！',' ♥︎什么都能c♥︎——艾欧尼亚有车位',' LGD-RNG 全程OB',' 账号评估，金秋打造增幅强化龙袍',' 爆天-至尊爆天甲-开不出来集合',' ★★耀光沙捐神器首战★★',' 迷离劫：钻石局',' 江南小姐姐~~我的温柔源于你们的偏爱',' 最有希望的四天！',' 无挂服：大师局！',' 杰克雷 全装号永久玩',' 【有车位】顶尖带枪指挥上车必吃鸡',' 全球仅此一家的独特蓝猫玩法',' Lehends直播',' 小希文食堂又开业辣！',' 【正在直播】单排9KD空投战神',' 峡谷王者再打一区王者定位赛','180合击-主宰合击-纯复古','  第一剑圣：电竞神雕侠侣，峡谷雌雄双煞','  关注我领取萌新和公会礼包哟~','  直播啦大哥们~~~~','  单排43杀 万杀8.2KD 随便玩','   司徒天香：周一好哇','   直播中：老卡特教学一区上王者','   又菜又莽的憨憨意 下饭主播！','   增幅天空送金秋套餐打造看号','   带我打游戏吧哥哥','   攻速神器-散人抗米激情给力','   ♥ 深渊团本不排队','   末日：技术主播没有GG','   OB黑铁4：国庆中秋快乐 意识操作拉满','   逆水寒之光！！！','   有车位 声优男神带你上大分','   都有都有都有','   点灯7-8 黄金雷诺 盘龙 爆天甲','   【有车位】浙江槿哥哥-顶级运营','   《军棋》感恩神丶易天大哥进驻总榜！','   降温了.有对象的抱对象.没对象的抱我','   【职业选手】推荐计划招募安排','10月友情卷 百城AK6件套','(广州)黑玫四川御姐音在线带粉~','3200可打定级赛哦','  【啊杰】快了 快了','  今天上1000000000000分','  D200：可上车22.23号活动','   兄弟萌 召唤师峡谷七日游阿 0V0','      【狮子】单排永远的神lion6p ✨','      卷毛：继续开始搞事！','      专业看号搭配测伤/帮金秋打造','       第一软辅重回千分!','       S4细节思路上分！！目标前十','       直播，国服最细盖伦','       新版白龙9杀视频上传，米诺陶专场','       峡谷宗师AD单排上分教学','       强化增幅龙袍金秋套-看号打桩搭配细节提升','       瑞兹王！三级必杀大师王者','       痒痒虫：电台','       新枪新赛季好爽啊！','       今天下午3点节目直播','       【精分声优】早安～','       【只打百强局】每天20盘百强局再下播','       D调：街头飞机上号～～～','       无人宠的小阔爱QAQ','       双节快乐！求支持！！！','       有位置❤1600的鱼苗','       愿你落寞时有人相伴，愿你迷茫时有人倾听','       祝大家国庆快乐 4026359','【老枪】手腕流第7天 轻喷~','少御音 艾欧尼亚有车位 等个宠我的人~','【LuLu】LGD-RNG 深渊联赛','先分享9.0怀旧服攻略字符串晚上PVP',' 飞机王者秒上号预定新赛季先下先打ohh！',' 各大区吴彦祖们晚上好~',' 偏执；聊聊球员王朝打法分析',' 无挂服上分机器！',' 【有车位】我就要玩福星！',' 合龙袍天空增幅送金秋'];let html='';let qps=1;let base=`<li style="margin-left: 15px;"><div style="display: inline-block;color: aquamarine;margin-top: 25px"><img src="/static/match/match5/img/image_number.png"alt=""><div style="display:flex;justify-content:space-between"><span>title_name</span><span style="align-self: flex-end">游戏天地</span></div><div style="display:flex;justify-content:space-between"><div style="display: inline-block"><svg style="width:18px;vertical-align: middle;fill: red;overflow: hidden;display: inline-block"xmlns="http://www.w3.org/2000/svg"viewBox="0 0 14 14"id="icon-user_c95acf8"><path d="M12 13H2c-.6 0-1-.4-1-1v-1c0-1.6 1.2-2.8 2.7-3 1 .6 2.1 1 3.3 1 1.2 0 2.3-.4 3.3-1 1.5.1 2.7 1.4 2.7 3v1c0 .6-.4 1-1 1zM7 7C5.3 7 4 5.7 4 4s1.3-3 3-3 3 1.3 3 3-1.3 3-3 3z"fill=""></path></svg><span>play_number</span></div><div style="display: inline-block"><svg style="width:18px;vertical-align: middle;fill: red;overflow: hidden;display: inline-block"xmlns="http://www.w3.org/2000/svg"viewBox="0 0 14 14"id="icon-user_c95acf8"><path d="M5.4 1s.3 3.1-2.6 4.6C-.1 7 .4 12 4.7 13c-1.4-2.1-.9-3.8 1.5-5.1.3 1.2 1 1.8 2 1.8 1.6 0 .6 3.2-.3 3.2s6.4 0 4.8-6.1c-.4-1-1.4-1.7-3.1-2.1C8.9 2.9 7.5 1.6 5.4 1z"fill=""></path></svg><span>hot_value</span></div></div></div></li>`;$.each(data,function(index,val){html+=base.replace('hot_value',val.value).replace('image_number',qps*window.page).replace('play_number',name[qps*window.page]).replace('title_name',title_name[qps*window.page]);qps+=1});$('.zbu').text('').append(html)},complete:function(){},error:function(){alert('cookie已失效');location.reload()}})};request()</script><script>window.page=1;$('.page-message').click(function(){window.page=$('.page-message').index(this)+1;request();$('.page-message').removeClass('active');$(this).addClass('active')});$('.next-page').click(function(){if(window.page<=4){window.page+=1;$('.page-message').removeClass('active').eq(window.page-1).addClass('active');request()}});$('.before-page').click(function(){if(window.page>1){window.page-=1;$('.page-message').removeClass('active').eq(window.page-1).addClass('active');request()}});</script><script>successAlert=function(message){let option={hook:{initStart:function(){}},popupTime:0,type:'alert',title:'答案正确',dragOverflow:true,content:'<i class="fas fa-check" style="color: deepskyblue"></i>'+message,};ModalLayer.alert(option)};failedAlert=function(message){let option={popupTime:2,hook:{initStart:function(){}},displayProgressBar:true,displayProgressBarPos:'top',displayProgressBarColor:'red',content:'<i class="fas fa-times" style="color: red"></i>'+message,};ModalLayer.msg(option)};</script><script>$(function(){$("#ajaxSubmit").on("click",function(){$("#ajaxForm").ajaxSubmit({beforeSubmit:function(){},success:function(data){result=data.status_code;if(result==="1"){poster_show()}else if(result==="5"){failedAlert('未登录，请检查登录状态\n您的IP：'+data.IP)}else{failedAlert('答案验证失败，再不...再想想？')}}})})})</script></body></html>